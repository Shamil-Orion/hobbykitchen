            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="bg-green-500 hover:bg-green-600 text-white rounded font-bold uppercase tracking-wider transition-colors flex items-center gap-3 justify-center px-8 py-3.5 mb-8"
                >
